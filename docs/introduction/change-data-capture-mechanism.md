...
* Q: If my data source supports CDC, how do I choose the CDC collection method?
  ...
  * **Field Polling**: Set the incremental synchronization method for the source node in Tapdata when [configuring the data transformation task](../design-incremental-views/create-views/README.md).