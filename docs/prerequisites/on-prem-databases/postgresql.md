...
* As a Target Node
  ...
  * **Specify Table Owner**: When syncing to PostgreSQL, you can define the owner for automatically created tables. Ensure the sync account has the necessary permissions by using `GRANT <tableOwner> TO <User>;`.
