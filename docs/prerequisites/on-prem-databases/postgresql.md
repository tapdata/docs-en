...
* As a Target Node
  ...
  * **Specify Table Owner**: When synchronizing to PostgreSQL, you can define the owner of automatically created tables. Ensure that the synchronization account has the necessary permissions.
