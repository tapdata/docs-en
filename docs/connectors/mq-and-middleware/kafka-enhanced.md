...
**Typical Use Case**: Used for **homogeneous data migration** or **unstructured data transformation**, enabling data filtering and transformation through a Kafka -> [JS Processing Node](../../operational-data-hub/mdm-layer/process-node.md#js-process) -> Kafka/MySQL data pipeline.
